...
public class Test3 {
	...
	public static void main(String[] args) {
		...
		wait.until(visibilityOfElementLocated(By.xpath("//input[@id='email']"))).sendKeys("batch37");
		wait.until(visibilityOfElementLocated(By.xpath("//input[@id='pass']"))).sendKeys("TestAutomation");
